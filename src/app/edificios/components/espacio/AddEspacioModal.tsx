...
import { Edificio, Sede, Espacio } from "../../../../types/api";
...
const AddEspacioModal: React.FC<AddEspacioModalProps> = ({ isOpen, onClose, edificios, onEspaciosAdded, showSuccessMessage }) => {
  const [espacios, setEspacios] = useState<Espacio[]>([]);
  const [error, setError] = useState<string | null>(null);
  const [newEspacio, setNewEdificio] = useState<Espacio>({
    id_edificio: 0,
    nombre: "",
    estado: "",
    clasificacion: "",

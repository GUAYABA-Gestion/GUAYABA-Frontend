...
interface EspacioTableProps {
  ...
  rol: string;
  onAddEspacioClick: () => void; // Nueva prop para manejar el clic en "Añadir Espacios"
}

const EspacioTable: React.FC<EspacioTableProps> = ({
  espacios,
  onEspacioClick,
  onEspacioSelect,
  selectedEspacioId,
  rol,
  onAddEspacioClick, // Recibir la prop
}) => {
